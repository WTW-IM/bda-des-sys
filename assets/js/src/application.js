...
!(function ($) {
  $(() => {
      ...
      $sideBar.affix({
        offset: {
          top() {
            ...
            var sideBarMargin = Number.parseInt($sideBar.children(0).css('margin-top'), 10);
    ...
    // "Light" Popovers (no-title)
    $('[data-toggle="popover-light"]').popover({
    ...
    zeroClipboard.on('noflash wrongflash', () => {
