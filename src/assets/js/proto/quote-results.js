$(() => {
  ...
  $.getJSON('/assets/js/proto/ifp.json', data => {
    $.each(data.plans, function (i) {
      ...
      var _el = '<li data-carrier="' + _carrier + '" data-premium="' + _premiumDollars + '.' + _premiumCents + '" data-rating="' + _rating + '" data-doctors="' + (_docsPct / 10) + '" data-annual="' + _annualData + '">'
        ...
        + '        <td class="full"><button type="button" class="popover-link" data-toggle="popover" data-trigger="focus" data-placement="bottom" data-html="true" data-container="#plan-tiles" data-content="<ul><li>Preferred Generic: ' + (_rxGenericDeductible ? (_rxGenericCoinsurance ? _rxGenericCostShare + '% coinsurance after deductible' : '$' + _rxGenericCostShare + ' copay after deductible') : '$' + _rxGenericCostShare + ' copay') + '</li><li>Preferred Brand: ' + (_rxBrandDeductible ? (_rxBrandCoinsurance ? _rxBrandCostShare + '% coinsurance after deductible' : '$' + _rxBrandCostShare + ' copay after deductible') : '$' + _rxBrandCostShare + ' copay') + '</li></ul><small>For copayments for other tiers of drugs under this plan, please see the plan details.</small>" title="Prescription Drug Coverage">' + (_rxGenericDeductible ? (_rxGenericCoinsurance ? _rxGenericCostShare + '%' : '$' + _rxGenericCostShare) : '$' + _rxGenericCostShare) + ' / ' + (_rxBrandDeductible ? (_rxBrandCoinsurance ? _rxBrandCostShare + '%' : '$' + _rxBrandCostShare) : '$' + _rxBrandCostShare) + '</button></td>'
        + '      </tr>'
        + '    </tbody>'
        + '  </table>'
        ...
        + '    <div class="checkbox chckbx pull-left disabled" title="Sorry, compare is not part of this test.">'
        + '      <label>'
