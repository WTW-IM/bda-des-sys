...
function AnchorJS(options) {
  ...
  this.add = function(selector) {
    ...
    if (!selector) {
      selector = 'h1, h2, h3, h4, h5, h6, div.bs-callout h4';
    ...
    for (i = 0; i < elements.length; i++) {
      ...
      anchor = '<span class="anchorjs-anchor" id="' + elementID + '"></span>';
      
      div1 = document.createElement('div');
      div1.innerHTML = anchor;
      anchorNodes1 = div1.childNodes;
      
      elements[i].parentNode.insertBefore(anchorNodes1[0], elements[i]);

      anchorLink = '<a class="anchorjs-link ' + this.options.class + '" href="#' + elementID + '" aria-label="Anchor link for: ' + readableID + '" data-anchorjs-icon="' + this.options.icon + '"></a>';

      div2 = document.createElement('div');
      div2.innerHTML = anchorLink;
      anchorNodes = div2.childNodes;
